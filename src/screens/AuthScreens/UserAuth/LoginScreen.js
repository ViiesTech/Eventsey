...
const LoginScreen = () => {
  ...
  const handleLogin = () => {
    ...
    alert('User login successful! Welcome to the Eventsey alpha!');
  };
    ...
    <ScreenWrapper scrollable>
      <View style={styles.container}>
        ...
        <View style={styles.logoContainer}>
          <AnimatedLogo />
          <Text style={styles.welcomeText}>User Portal</Text>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'transparent', // Yeh transparent hi rehna chahiye
    paddingVertical: responsiveHeight(2),
    // paddingHorizontal yahan se bilkul hata dein! Wrapper handles it.
  },
  header: {
